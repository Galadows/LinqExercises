...
public static void Ex2()
{
    ...
    logEnum<string>(moreThan5Letters);
    Console.WriteLine("start with P, more than 4 letters, contains o but not m:");
    logEnum<string>(startWithPmoreThan4LettersContainsOButNotM);
    Console.WriteLine("sorted by length:");
    logEnum<string>(sortedByLength);
    Console.WriteLine();
}

static void logEnum<T>(IEnumerable<T> COLLECTION)
{
